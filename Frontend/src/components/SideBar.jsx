...
function Sidebar({ vista, setVista, handleLogout, user }) {
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-gray-200 space-y-2">
            <Link
              to="/"
              className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-all"
              onClick={() => setIsOpen(false)}
            >
              <svg
                className="w-5 h-5"
